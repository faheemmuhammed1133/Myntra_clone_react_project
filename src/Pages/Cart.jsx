...
const Cart = () => {
  ...
  const placeOrderObj = {
    ...
    "Discount on MRP":(<span style={{ textDecoration: 'line-through' }}> {resultStriked-resultcount}</span>)
  };
      ...
      >
        ...
        >
          ...
          >
            ...
            <Button _hover={{ backgroundColor: "white", color: "#ff6700", border: "1px solid #000" }} w={"100%"} mt={"2rem"} color={"white"} backgroundColor={"#ff6700"} onClick={() => {
              goToAddress("/address");
